...
beautiful.init(gears.filesystem.get_configuration_dir() .. "clrawesome.lua")
...
"xrandr --output eDP-1 --primary --mode 1920x1080 --pos 2560x0 --rotate normal --output HDMI-1 --mode 2560x1080 --pos 0x0 --rotate normal --output DP-1 --off")
